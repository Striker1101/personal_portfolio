        ...
        <div className="headerAbout">
          ...
          <div>
            <em>
              ...
              with good computer enginerring skill and knowlege on Microsoft
              suits
            </em>
            <p style={{ paddingTop: "10px", marginTop: "10px" }}>
              Today I'm enthralled by web development. Creating new experiences,
              implementing eye pleasing designs and making them come to life
              with animation is what I do best.
            </p>
          </div>
          <div className="links">
            <a
              href="https://docs.google.com/document/d/1oEH8lbeazSLKECcZ2JwV8gYYM67n5PWf/edit?usp=sharing&ouid=105954011485166323040&rtpof=true&sd=true"
              download
            >
              <button
                style={{
