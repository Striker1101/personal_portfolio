...
export default function Projects() {
    ...
    <div className="cards">
      <div className="workcard">
        ...
        <div className="workCardText">
          ...
          <div className="workcardBody">
            <p>
              crypto currency app for users to trade and get live trading chat, with added security and an admin account   
            </p>
            <hr />
            <div>
      ...
      <div className="workcard">
        ...
        <div className="workCardText">
          ...
          <div className="workcardBody">
            <p>
             Proto-type shopping app for online accessory 
             and game gadget from fortnight apis, with custom
              component to render this shopping APi stream
            </p>
            <hr />
            <div>
              <p>react</p>
      ...
      <div className="workcard">
        ...
        <div className="workCardText">
          ...
          <div className="workcardBody">
            <p>
              Full-stack application with leaderboard,
               played by on one individual player with
                3 board to choose from and option to 
                add more 
            </p>
            <hr />
            <div>
      ...
      <div className="workcard">
        ...
        <div className="workCardText">
          ...
          <div className="workcardBody">
            <p>
             Dual or single  player game, where each 
             player assign ships to board coordinates and aim 
             to kill enemy ship from the shot board
            </p>
            <hr />
            <div>
              <p>Webpack, Js</p>
      ...
      <div className="workcard">
        ...
        <div className="workCardText">
          ...
          <div className="workcardBody">
            <p>
              Dynamic route website, for users to perform any crud method on Books, with access to read and write directly to db 
            </p>
            <hr />
            <div>
  ...
  <div
      ...
      width: "100%"
        ...
        type="submit">
          <a href="https://github.com/Striker1101">See more</a>
        </button>
      </div>
  </>
  )
